...
Transform* PrefabManager::CreateGround(Transform* parent)
{
    ...
    ground->GetComponent<MeshRenderer>()->SetTexture(TextureLoader::GetTextureByName("Snow"));
...
Transform* PrefabManager::CreateTree(Transform* parent)
{
    ...
    treeTrunk->GetComponent<MeshRenderer>()->SetTexture(TextureLoader::GetTextureByName("TreeBark"));
    ...
    treeCorona->GetComponent<MeshRenderer>()->SetTexture(TextureLoader::GetTextureByName("TreeCorona"));
...
Transform* PrefabManager::CreateRock(Transform* parent)
{
    ...
    rock1->GetComponent<MeshRenderer>()->SetTexture(TextureLoader::GetTextureByName("Rock"));
    ...
    rock2->GetComponent<MeshRenderer>()->SetTexture(TextureLoader::GetTextureByName("Rock"));
...
Transform* PrefabManager::CreateLightPole(Transform* parent)
{
    ...
    verticalPole->GetComponent<MeshRenderer>()->SetTexture(TextureLoader::GetTextureByName("LightPole"));
    ...
    horizontalPole->GetComponent<MeshRenderer>()->SetTexture(TextureLoader::GetTextureByName("LightPole"));
...
Transform* PrefabManager::CreatePresent(Transform* parent)
{
    ...
    presentBox->GetComponent<MeshRenderer>()->SetTexture(TextureLoader::GetTextureByName("Present"));
...
Transform* PrefabManager::CreateMarker(Transform* parent)
{
    Transform* marker = new Transform(parent, "Marker");
    Marker* markerComponent = new Marker(marker);
    markerComponent->speed = 5.0f;
    markerComponent->rotationSpeed = 1.5f;
    marker->AddComponent(markerComponent);
    
    Transform* markerBase = new Transform(marker, "Base");
    markerBase->Translate(glm::vec3(0, 1.66f, 0));
    markerBase->Rotate(glm::vec3(glm::radians(90.0f), 0, 0));
    markerBase->SetScale(glm::vec3(5, 5, 1));
    markerBase->AddComponent(new MeshRenderer(markerBase, MeshRenderer::Circle, "markerBase", MaterialManager::GetMaterial(MaterialManager::MAT_DEFAULT_LIT),
        MeshRenderer::Default, glm::vec3(1, 1, 1), glm::vec4(251, 116, 255, 255) / 255.0f));
    markerBase->GetComponent<MeshRenderer>()->SetTexture(TextureLoader::GetTextureByName("White"));

    Transform* markerPointer = new Transform(marker, "Pointer");
    markerPointer->Translate(glm::vec3(0, 11.92f, 0));
    markerPointer->SetScale(glm::vec3(1.5f, 6.34f, 1.5f));
...
Transform* PrefabManager::CreateFractalTreeRoot(Transform* parent)
{
...
Transform* PrefabManager::CreateFractalTreeSegment(Transform* parent)
{
    Transform* fractalTreeSegment = new Transform(parent, "Fractal Tree Segment");
    fractalTreeSegment->AddComponent(new FractalTreeSegment(fractalTreeSegment));
...
Transform* PrefabManager::CreatePhysicsCube(Transform* parent)
{
    ...
    physicsObj->AddComponent(new MeshRenderer(physicsObj, MeshRenderer::Cube, "physicsBox", MaterialManager::GetMaterial(MaterialManager::MAT_SIMPLE),
        MeshRenderer::Default, glm::vec3(1), col));
    physicsObj->GetComponent<MeshRenderer>()->SetTexture(TextureLoader::GetTextureByName("Player3"));
    physicsObj->AddComponent(new Rigidbody(physicsObj, 14.0f, 0.4f));
...
Transform* PrefabManager::CreatePhysicsCone(Transform* parent)
{
    ...
    physicsObj->AddComponent(new MeshRenderer(physicsObj, MeshRenderer::Cone, "physicsCone", MaterialManager::GetMaterial(MaterialManager::MAT_SIMPLE),
        MeshRenderer::Default, glm::vec3(1), col));
    physicsObj->GetComponent<MeshRenderer>()->SetTexture(TextureLoader::GetTextureByName("Player3"));
    physicsObj->AddComponent(new Rigidbody(physicsObj, 16.0f, 0.5f));
